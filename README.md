...
ConsumerInterfaceConcept.java

FunctionInterfaceConcept.java

LambdaDeclare.java

LambdaExpAndMethodReferences.java

PredicateInterfaceConcept.java

SupplierInterfaceConcept.java

ThreadDemo.java

UnaryOperatorInterface.java
...
ParallelStreamConcept.java

PrimeNumberWithParallelStream.java

SequentialStream.java
